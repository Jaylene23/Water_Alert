...
<body>
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <div class="bar-bg">
        <div id="barFill" class="bar-fill" style="width:0%;background:#22c55e;"></div>
      </div>
      <p class="hint">⚠️ Alert triggers when level drops below 20%</p>
    </div>

    <div class="card full">
      <h3>📋 Recent Activity <span style="font-size:.75rem;font-weight:400;color:var(--muted)">(Last 10 entries)</span>
      </h3>
      <table>
        <thead>
          <tr>
